...
var songData:Array<SongColorData> = [
    ...
    // Prelude
    { r1: 0.259, r2: 0.537, r3: 0.278, g: [0.533,0.718,1.0] },

    // Week 1
    { r1: 0.251, r2: 0.353, r3: 0.522, g: [0.518,0.459,0.247] },
    { r1: 0.251, r2: 0.353, r3: 0.522, g: [0.518,0.459,0.247] },
    { r1: [0.251,0.353,0.522], g: [0.518,0.459,0.247] },

    // Week 2
    { r1: [0.965,0.835,0.937], g: [0.835,0.608,0.502] },
    { r1: [0.965,0.835,0.937], g: [0.835,0.608,0.502] },
    { r1: [0.082,0.141,0.188], g: [0.561,0.518,0.455] },

    // Week 3
    { r1: [0.800,0.439,0.612], g: [0.094,0.451,0.333] },
    { r1: [0.800,0.439,0.612], g: [0.094,0.451,0.333] },
    { r1: [0.800,0.439,0.612], g: [0.094,0.451,0.333] },

    // Week 4
    { r1: [0.702,0.686,1.0], g: [0.941,0.600,0.667] },
    { r1: [0.702,0.686,1.0], g: [0.941,0.600,0.667] },
    { r1: [0.702,0.686,1.0], g: [0.941,0.600,0.667] },

    // Week 5
    { r1: [1.0,0.757,0.651], g: [0.412,0.541,0.737] },
    { r1: [1.0,0.757,0.651], g: [0.412,0.541,0.737] },
    { r1: [0.082,0.141,0.188], g: [0.561,0.518,0.455] },

    // Week 6
    { r1: [0.467,0.682,0.851], g: [0.451,0.286,0.067] },
    { r1: [0.467,0.682,0.851], g: [0.451,0.286,0.067] },
    { r1: [0.467,0.682,0.851], g: [0.451,0.286,0.067] },

    // Epilogue
    { r1: [0.259,0.537,0.278], g: [0.533,0.718,1.0] },

    // Extra
    { r1: [0.573,0.443,0.992], g: [0.353,0.553,0.004] },
    { r1: [0.275,0.275,0.275], g: [0.706,0.706,0.706] },
    { r1: [0.698,0.698,0.698], g: [0.941, 0.941, 0.941] }
];
